...
PORTFOLIO.pages = [
    ...
    blocks: [
      ...
      {"t":"sub","html":"전부 같은 방식으로, 사지방에서 혼자 만들고 있습니다.","variant":"tight"},
      {
        ...
        "items": [
          ...
          {"n":"WEB · APP","title":"러브 메모리","desc":"연인이 함께 쓰는 캘린더. <b>비공개 테스터를 모집해 운영 중이며 출시를 준비하고 있습니다.</b> 다음 쪽에 화면과 설계를 따로 정리했습니다. <a href=\"#\" data-goto=\"love-memory\">자세히 보기</a>"},
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        "t": "sub",
        "html": "군 복무 중 사지방에서 만들고 있는 앱입니다. 기획·디자인·개발·운영을 혼자 하고 있고, 지금은 <b>비공개 테스터를 모집해 피드백을 받는 단계</b>입니다. 정식 출시를 준비하고 있으며, 아래는 실제 동작 화면입니다."
      },
      {
        "t": "shots",
        "items": [
      ...
      },
      {
        ...
        "tags": ["웹 앱 · 모바일 우선","Vercel 배포","2인 공유 모델","기획 · 디자인 · 개발 · 운영 1인"],
        "links": [
          {"href":"https://couple-app-tau-rouge.vercel.app/","external":true,"icon":"▶","text":"직접 사용해 보기"}
        ],
        "decs": [
          {"n":"DESIGN 01","title":"둘만의 공유 모델","desc":"모든 기록에 누가 남겼는지가 붙습니다. 사진에는 <b>‘파트너가 올림’</b>, 일정에는 <b>‘파트너가 등록’</b>, 이야기에는 이름이 따라붙고, 할 일은 아예 ‘내 할 일’과 ‘파트너 할 일’로 나눴습니다. 2인이라 권한 규칙 자체는 단순하지만, 누가 무엇을 했는지 보이지 않으면 함께 쓰는 느낌이 사라진다고 봤습니다."},
        ...
        "foot": "▸ <b>비공개 테스터를 모집해 운영 중</b>입니다. 받은 피드백을 반영하며 정식 출시를 준비하고 있습니다.<br/>▸ 출시 준비 일정도 이 앱으로 관리하고 있습니다 — 위 달력의 초록색 띠가 그것입니다.",
        "genre": "커플 캘린더"
      }
    ]
  },
