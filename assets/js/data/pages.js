...
PORTFOLIO.pages = [
    ...
    blocks: [
      ...
      {"t":"sub","html":"전부 같은 방식으로, 사지방에서 혼자 만들고 있습니다.","variant":"tight"},
      {
        ...
        "items": [
          ...
          {"n":"WEB · APP","title":"러브 메모리","desc":"연인이 함께 쓰는 캘린더. <b>구글 플레이 비공개 테스트를 운영하며 출시를 준비하고 있습니다.</b> 다음 쪽에 화면과 설계를 따로 정리했습니다. <a href=\"#\" data-goto=\"love-memory\">자세히 보기</a>"},
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        "t": "sub",
        "html": "군 복무 중 사지방에서 만들고 있는 앱입니다. 기획·디자인·개발·운영을 혼자 하고 있고, 지금은 <b>구글 플레이 비공개 테스트</b>를 열어 피드백을 받는 단계이고, 정식 출시를 준비하고 있습니다. 아래는 실제 동작 화면입니다."
      },
      {
        "t": "shots",
        "items": [
      ...
      },
      {
        ...
        "tags": ["React","Next.js","Firebase","Vercel 배포","2인 공유 모델","기획 · 디자인 · 개발 · 운영 1인"],
        "links": [
          {"href":"https://couple-app-tau-rouge.vercel.app/","external":true,"icon":"▶","text":"직접 사용해 보기"}
        ],
        "decs": [
        ...
        "foot": "▸ <b>구글 플레이 비공개 테스트를 운영 중</b>입니다. 받은 피드백을 반영하며 정식 출시를 준비하고 있습니다.<br/>▸ 출시 준비 일정도 이 앱으로 관리하고 있습니다 — 위 달력의 초록색 띠가 그것입니다.",
        "genre": "커플 캘린더"
      }
    ]
  },
