  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        "h": "개요",
        "body": [
          {"k":"list","items":["<b>성격</b> — 3D 액션 및 시스템 구축 중심의 장기 팀 프로젝트. 기술적 확장성을 고려한 아키텍처 설계와 팀 협업 파이프라인 구축에 집중","<b>핵심 목표</b> — 효율적인 아키텍처 설계 및 BIC 출품","<b>규모</b> — 20인 팀 / 8개월","<b>역할</b> — TD (Technical Director)"]}
        ]
      },
      {
        "t": "blk",
    ...
    blocks: [
      {
        ...
        "title": "Dirty Guilty",
        "lead": "<b>11인 팀</b>의 TD로, A* 알고리즘을 직접 구현한 추격 AI와 분기·멀티 엔딩 구조를 설계했습니다.",
      ...
      },
      {
        ...
        "h": "개요",
        "body": [
          {"k":"list","items":["<b>성격</b> — 루프물 기반의 다중 엔딩 도트 어드벤처 게임","<b>규모</b> — 11인 팀 / 6주 (1학년 2학기 여름방학)","<b>역할</b> — TD (Technical Director)"]}
        ]
      },
      {
        "t": "blk",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        "h": "개요",
        "body": [
          {"k":"list","items":["<b>성격</b> — AI를 활용한 미연시 (비주얼 노벨)","<b>기간</b> — 10일 (1학년 1학기 수업 중)","<b>역할</b> — TD (Technical Director) 및 PD"]}
        ]
      },
      {
        "t": "blk",
